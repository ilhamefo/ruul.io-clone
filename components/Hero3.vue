<script setup>
const heroData = ref({
  title: "The New Way Of Work",
  header: "Tailored for the new economy",
  description:
  ...
  cards: [
    ...
    },
    {
      ...
      footer: "10k+ businesses use Ruul"
...
<template>
  ...
  <div
    class="py-[40px] px-[21.25px] md:py-[120px] lg:py-[140px] md:px-[40px] flex flex-col  text-[#cafdc6] relative container-custom"
  >
